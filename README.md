...
Implementação do curso do [fastapidozero.dunossauro.com](https://fastapidozero.dunossauro.com).

API REST para gerenciamento de usuários e tarefas, seguindo boas práticas de segurança e arquitetura moderna.

Tecnologias e Arquitetura
FastAPI: Framework moderno com documentação automática
SQLAlchemy Async: ORM assíncrono para melhor performance
